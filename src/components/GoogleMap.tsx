    ...
    <>
      <div className="row m-0 p-0 w-100 overflow-hidden">
            ...
            <div className="row">
              <div className="col py-5">
                <div className="contactForm">
                  <div className="isolate text-light px-6 py-24 sm:py-32 lg:px-8">
                    <div
        ...
        <label className="text-sm/6 text-gray-600" id="switch-1-label">
          By selecting this, you agree to our <a href="#" className="font-semibold text-indigo-600 ms-1">privacy&nbsp;policy</a>.
        </label>
      </div> */}
                      </div>
                      <div className="mt-10">
